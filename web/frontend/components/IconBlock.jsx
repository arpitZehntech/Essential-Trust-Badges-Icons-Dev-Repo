...
//       <Stack>
//         <Stack.Item>
//           <span className="Polaris-TextStyle--variationStrong">Icon #1</span>
//         </Stack.Item>
...
//                 onChange={(value) => {
//                   const newPages = [...pages];
//                   newPages[index].subheading = value;
//                   setPages(newPages);
//                 }}
//                 autoComplete="off"
//               />
...
//                     <LegacyStack.Item>
//                       <div
//                         className={`icon-preview ${page.selectedIcon ? 'selected' : ''}`}
//                         onClick={() => toggleIconModal(index)}
//                         style={{ cursor: 'pointer' }}
//                       >
//                         {page.selectedIcon ? (
//                           <span className="Polaris-Thumbnail Polaris-Thumbnail--sizeLarge">
//                             {page.selectedIcon.icon}
//                           </span>
//                         ) : (
//                           <span className="Polaris-Icon Polaris-Icon--colorSubdued Polaris-Icon--applyColor">
//                             <span className="Polaris-Text--root Polaris-Text--visuallyHidden"></span>
...
//                           <Button onClick={() => {
//                             const newPages = [...pages];
//                             newPages[index].selectedIcon = null;
//                             setPages(newPages);
//                           }} fullWidth>
//                             Remove Icon
//                           </Button>
...
//               </LegacyStack>
//               <IconSelector
//                 active={iconModalActive && iconModalActiveIndex === index}
//                 toggleModal={() => toggleIconModal(index)}
//                 onIconSelect={(icon) => {
//                   const newPages = [...pages];
//                   newPages[index].selectedIcon = icon;
//                   setPages(newPages);
//                   setIconModalActive(false);
//                 }}
//               />
...
//                 onChange={(value) => {
//                   const newPages = [...pages];
//                   newPages[index].cta = value;
//                   newPages[index].buttonText = 'Shop Now';
//                   newPages[index].linkType = '';
//                   newPages[index].selectedProduct = null;
//                   newPages[index].selectedCollection = null;
//                   newPages[index].externalUrl = '';
//                   setPages(newPages);
//                 }}
//                 options={[
//                   { label: 'No call to action', value: 'no-cta' },
...
//                 ]}
//               />
//               {page.cta === 'button-cta' || page.cta === 'clickable-banner-cta' ? (
//                 <>
...
//                         onChange={(value) => {
//                           const newPages = [...pages];
//                           newPages[index].buttonText = value;
//                           setPages(newPages);
//                         }}
//                       />
//                     </div>
...
//                                     className="Polaris-RadioButton__Input"
//                                     value="product"
//                                     checked={page.linkType === 'product'}
//                                     onChange={() => {
//                                       const newPages = [...pages];
//                                       newPages[index].linkType = 'product';
//                                       setPages(newPages);
//                                     }}
//                                   />
//                                   <span className="Polaris-RadioButton__Backdrop"></span>
...
//                                     className="Polaris-RadioButton__Input"
//                                     value="collection"
//                                     checked={page.linkType === 'collection'}
//                                     onChange={() => {
//                                       const newPages = [...pages];
//                                       newPages[index].linkType = 'collection';
//                                       setPages(newPages);
//                                     }}
//                                   />
//                                   <span className="Polaris-RadioButton__Backdrop"></span>
...
//                                     className="Polaris-RadioButton__Input"
//                                     value="external"
//                                     checked={page.linkType === 'external'}
//                                     onChange={() => {
//                                       const newPages = [...pages];
//                                       newPages[index].linkType = 'external';
//                                       setPages(newPages);
//                                     }}
//                                   />
//                                   <span className="Polaris-RadioButton__Backdrop"></span>
...
//                         onChange={(value) => {
//                           const newPages = [...pages];
//                           newPages[index].externalUrl = value;
//                           setPages(newPages);
//                         }}
//                       />
//                     )}
//                   </div>
//                   <ProductPicker
//                     isOpen={isProductPickerOpen && pageIndex === index}
//                     onSelectProduct={(product) => {
//                       const newPages = [...pages];
//                       newPages[index].selectedProduct = product;
//                       setPages(newPages);
...
//                   />
//                   <CollectionPicker
//                     isOpen={isCollectionPickerOpen && pageIndex === index}
//                     onSelectCollection={(collection) => {
//                       const newPages = [...pages];
//                       newPages[index].selectedCollection = collection;
//                       setPages(newPages);
...
//                 </>
//               ) : null}
//               {page.linkType === 'product' && page.selectedProduct && (
//                 <div className="Polaris-FormLayout__Item">
//                   <div className="Polaris-LegacyCard">
//                     <div className="Polaris-LegacyCard__Section">
//                       <div className="Polaris-LegacyStack">
//                         <div className="Polaris-LegacyStack__Item">
//                           <span className="Polaris-Thumbnail Polaris-Thumbnail--sizeMedium">
//                             <img className="productImgCls" alt={page.selectedProduct.title} src={page.selectedProduct.images[0]?.originalSrc} />
//                           </span>
//                         </div>
//                         <div className="Polaris-LegacyStack__Item">
//                           <div className="Polaris-LegacyStack Polaris-LegacyStack--vertical Polaris-LegacyStack--spacingExtraTight Polaris-LegacyStack--distributionLeading Polaris-LegacyStack--alignmentLeading">
//                             <div className="Polaris-LegacyStack__Item">
//                               <p className="Polaris-Text--root Polaris-Text--bodyMd Polaris-Text--semibold">
//                                 {page.selectedProduct.title}
//                               </p>
//                             </div>
//                             <div className="Polaris-LegacyStack__Item">
//                               <p className="Polaris-Text--root Polaris-Text--bodySm">
//                                 {page.selectedProduct.handle}
//                               </p>
//                             </div>
//                           </div>
//                         </div>
...
//                 </div>
//               )}
//               {page.linkType === 'collection' && page.selectedCollection && (
//                 <div className="Polaris-FormLayout__Item">
//                   <div className="Polaris-LegacyCard">
//                     <div className="Polaris-LegacyCard__Section">
//                       <div className="Polaris-LegacyStack">
//                         <div className="Polaris-LegacyStack__Item">
//                           <span className="Polaris-Thumbnail Polaris-Thumbnail--sizeMedium">
//                             <img className="collectionImgCls" alt={page.selectedCollection.title} src={page.selectedCollection.image?.originalSrc} />
//                           </span>
//                         </div>
//                         <div className="Polaris-LegacyStack__Item">
//                           <div className="Polaris-LegacyStack Polaris-LegacyStack--vertical Polaris-LegacyStack--spacingExtraTight Polaris-LegacyStack--distributionLeading Polaris-LegacyStack--alignmentLeading">
//                             <div className="Polaris-LegacyStack__Item">
//                               <p className="Polaris-Text--root Polaris-Text--bodyMd Polaris-Text--semibold">
//                                 {page.selectedCollection.title}
//                               </p>
//                             </div>
//                             <div className="Polaris-LegacyStack__Item">
//                               <p className="Polaris-Text--root Polaris-Text--bodySm">
//                                 {page.selectedCollection.handle}
//                               </p>
//                             </div>
//                           </div>
//                         </div>
...
//               )}
//             </div>
//             <div class="Polaris-FormLayout__Item"><div class="Polaris-LegacyStack"><div class="Polaris-LegacyStack__Item"><button class="Polaris-Button Polaris-Button--disabled Polaris-Button--plain Polaris-Button--iconOnly" aria-disabled="true" type="button" tabindex="-1"><span class="Polaris-Button__Content"><span class="Polaris-Button__Icon"><span class="Polaris-Icon"><span class="Polaris-Text--root Polaris-Text--visuallyHidden"></span><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true"><path d="M15 13a.997.997 0 0 1-.707-.293l-4.293-4.293-4.293 4.293a.999.999 0 1 1-1.414-1.414l5-5a.999.999 0 0 1 1.414 0l5 5a.999.999 0 0 1-.707 1.707z"></path></svg></span></span></span></button></div><div class="Polaris-LegacyStack__Item"><button class="Polaris-Button Polaris-Button--plain Polaris-Button--iconOnly" type="button"><span class="Polaris-Button__Content"><span class="Polaris-Button__Icon"><span class="Polaris-Icon"><span class="Polaris-Text--root Polaris-Text--visuallyHidden"></span><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true"><path d="M10 14a.997.997 0 0 1-.707-.293l-5-5a.999.999 0 1 1 1.414-1.414l4.293 4.293 4.293-4.293a.999.999 0 1 1 1.414 1.414l-5 5a.997.997 0 0 1-.707.293z"></path></svg></span></span></span></button></div><div class="Polaris-LegacyStack__Item Polaris-LegacyStack__Item--fill"><div class="sc-fBWQRz cztqTf"><button type="button" class="Polaris-Link Polaris-Link--monochrome">    
//                     <span className="Polaris-Button__Content">
//                       <span className="Polaris-Button__Text"  onClick={() => removePage(index)}>Remove Page</span>
//                     </span>
...
//       ))}
//       <Stack.Item>
//         <Button onClick={addPage} fullWidth>
//           <span className="Polaris-Button__Content">
//             <span className="Polaris-Button__Icon">
//               <span className="Polaris-Icon">
//                 <span className="Polaris-Text--root Polaris-Text--visuallyHidden"></span>
...
//               </span>
//             </span>
//             <span className="Polaris-Button__Text">Add Page</span>
//           </span>
//         </Button>
//       </Stack.Item>
//     </div>
